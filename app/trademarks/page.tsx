  ...
  return (
    <main className={styles.page}>
      ...
      <div className={styles.body}>
        ...
        <section><h2>ECplayersの表示方針</h2><p>第三者のロゴ、ブランドデザイン等を無断でECplayersのブランドとして使用せず、第三者との提携・公認を誤認させる表現を避けます。対応先を示す必要がある場合は、ECplayersを主ブランドとして明確に表示し、第三者名は説明的に用います。</p><p>制定日：2026年8月8日</p></section>
