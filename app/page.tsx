...
const apps = [
  ...
  },
  {
    ...
    number: '02',
    title: '楽天競合店ウォッチャー',
    description: '競合ショップを登録し、商品点数・新着商品・納期確認のURLを1画面にまとめる。',
    tags: ['楽天', '競合調査', '無料'],
    href: '/rakuten-watch',
    action: '今すぐ使う →',
  },
    ...
    <main className={styles.page}>
      ...
      <section className={styles.hero}>
        ...
        <div className={styles.appStack} aria-label="ECPのアプリイメージ">
          ...
          <article className={styles.stackSub}><span>02</span><div><small>LIVE</small><strong>楽天競合店ウォッチャー</strong></div><b>→</b></article>
