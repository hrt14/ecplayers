...
const apps = [
  ...
  },
  {
    ...
    number: '03',
    title: 'らくらくーぽん計算機',
    description: 'レビュー施策の実コストから、レビュー1件あたりの獲得単価とレビュー率を10秒で計算。',
    tags: ['楽天', 'レビュー', '無料'],
    href: '/rakurakupon-review-cost',
    action: '今すぐ計算 →',
  },
  {
    status: 'BUILDING',
    ...
    <main className={styles.page}>
      ...
      <section className={styles.hero}>
        ...
        <div className={styles.appStack} aria-label="ECPのアプリイメージ">
          ...
          <article className={styles.stackSub}><span>03</span><div><small>LIVE</small><strong>らくらくーぽん計算機</strong></div><b>→</b></article>
          <article className={styles.stackSub}><span>04</span><div><small>BUILDING</small><strong>商品比較</strong></div><b>→</b></article>
        </div>
      </section>
