  ...
  return (
    <main className={styles.page}>
      ...
      <div className={styles.body}>
        ...
        <section><h2>3. 利用目的</h2><ul><li>各アプリ・サービス機能の提供</li><li>分析結果、比較結果、提案その他の機能結果の表示</li><li>不具合調査、セキュリティ確保、品質改善</li><li>利用状況の統計的な分析</li><li>重要な仕様変更、規約変更等の案内</li></ul></section>
        ...
        <section><h2>7. お問い合わせ</h2><p>本ポリシーに関するお問い合わせは、株式会社まんがびと公式サイトからご連絡ください。</p><p>制定日：2026年8月8日<br />最終改定日：2026年8月26日</p></section>
